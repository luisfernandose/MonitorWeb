...
namespace Queue.Controllers
{
    public class OperationController : Controller
    {
        ...
        public List<BasicStatsDashboard> GetDataForDashBoard(string idcompany)
        {
            try
            {
                ...
                //var _startTest = new DateTime(DateTime.Today.Year, DateTime.Today.Month, DateTime.Today.Day);
                //var _endTest = new DateTime(DateTime.Today.Year, DateTime.Today.Month, DateTime.Today.Day);
                ...
                List<BasicStatsDashboard> queryPrincipal = MongoHelper.database.GetCollection<AutomaticTakeTimeModel>("TrackerTime").AsQueryable<AutomaticTakeTimeModel>().
